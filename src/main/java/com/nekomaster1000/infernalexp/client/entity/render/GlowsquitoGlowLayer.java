...
@OnlyIn(Dist.CLIENT)
public class GlowsquitoGlowLayer<T extends GlowsquitoEntity, M extends EntityModel<T>> extends AbstractEyesLayer<T, M> {
    ...
    public GlowsquitoGlowLayer(IEntityRenderer<T, M> rendererIn) {
        super(rendererIn);
    }
