...
public class VolineGlowLayer<T extends VolineEntity, M extends EntityModel<T>> extends AbstractEyesLayer<T, M> {
    ...
    private static final RenderType RENDER_TYPE = RenderType.getEyes(new ResourceLocation(InfernalExpansion.MOD_ID, "textures/entity/voline_glow.png"));
    private static final RenderType TIRED_RENDER_TYPE = RenderType.getEyes(new ResourceLocation(InfernalExpansion.MOD_ID, "textures/entity/voline_tired_glow.png"));
