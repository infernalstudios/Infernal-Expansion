...
public class GlowSpikeLargeFeature extends ModFeature {

    private static final int minDiameter = 3;
    private static final int maxDiameter = 6;
    private static final int minHeight = 12;
    private static final int maxHeight = 98;
    private static final int maxXOffset = 7;
    private static final int maxZOffset = 7;

    public GlowSpikeLargeFeature(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    /**
     * Places a line of blocks from the startPos to the endPos. It uses the appropriate blocks to make a {@link GlowSpikeLargeFeature}
