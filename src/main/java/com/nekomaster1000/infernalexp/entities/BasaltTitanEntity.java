...
public class BasaltTitanEntity extends CreatureEntity implements IAngerable {
    ...
    public BasaltTitanEntity(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
