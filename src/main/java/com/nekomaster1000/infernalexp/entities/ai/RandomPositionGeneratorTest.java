...
public class RandomPositionGeneratorTest {
     ...
     */
    @Nullable
    public static Vector3d findRandomTargetBlockAwayFrom(MobEntity entitycreatureIn, int xz, int y, Vector3d targetVec3) {
        Vector3d vector3d = entitycreatureIn.getPositionVec().subtract(targetVec3);
        return func_226339_a_(entitycreatureIn, xz, y, 0, vector3d, true, (double) ((float) Math.PI / 2F), value -> 10.0f, false, 0, 0, true);
    }
    ...
    @Nullable
    private static Vector3d func_226339_a_(MobEntity p_226339_0_, int p_226339_1_, int p_226339_2_, int p_226339_3_, @Nullable Vector3d p_226339_4_, boolean p_226339_5_, double p_226339_6_, ToDoubleFunction<BlockPos> p_226339_8_, boolean p_226339_9_, int p_226339_10_, int p_226339_11_, boolean p_226339_12_) {
