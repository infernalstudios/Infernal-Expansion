...
public class GlowFireBlock extends AbstractFireBlock {
    ...
    protected final Object2IntMap<Block> encouragements = new Object2IntOpenHashMap<>();
    protected final Object2IntMap<Block> flammabilities = new Object2IntOpenHashMap<>();

    public GlowFireBlock(Properties properties) {
        ...
        this.stateToShapeMap = ImmutableMap.copyOf(this.stateContainer.getValidStates().stream().filter((state) -> state.get(AGE) == 0).collect(Collectors.toMap(Function.identity(), GlowFireBlock::getShapeForState)));
    }
    ...
    public static void init() {
        GlowFireBlock fireblock = (GlowFireBlock)Blocks.FIRE;
