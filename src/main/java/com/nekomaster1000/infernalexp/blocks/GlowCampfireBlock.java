...
public class GlowCampfireBlock extends ContainerBlock implements IWaterLoggable {
    ...
    public GlowCampfireBlock(boolean smokey, int fireDamage, AbstractBlock.Properties properties) {
        ...
        this.setDefaultState(this.stateContainer.getBaseState().with(LIT, Boolean.TRUE).with(SIGNAL_FIRE, Boolean.FALSE).with(WATERLOGGED, Boolean.FALSE).with(FACING, Direction.NORTH));
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (tileentity instanceof GlowCampfireTileEntity) {
            GlowCampfireTileEntity campfiretileentity = (GlowCampfireTileEntity) tileentity;
    ...
    public static void extinguish(IWorld world, BlockPos pos, BlockState state) {
        ...
        if (tileentity instanceof GlowCampfireTileEntity) {
            ((GlowCampfireTileEntity)tileentity).dropAllItems();
        }
