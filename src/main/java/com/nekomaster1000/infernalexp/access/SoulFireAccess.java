...
public interface SoulFireAccess {
	...
	public static enum KnownFireTypes {
		FIRE("fire", ModelBakery.LOCATION_FIRE_0, ModelBakery.LOCATION_FIRE_1), SOUL_FIRE("soul_fire", LOCATION_SOUL_FIRE_0, LOCATION_SOUL_FIRE_1), FIRE_GLOW("fire_glow", LOCATION_FIRE_0_GLOW, LOCATION_FIRE_1_GLOW), ENDER_FIRE("ender_fire", LOCATION_ENDER_FIRE_0, LOCATION_ENDER_FIRE_1);
