...
public class ModConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> GLOWDUST_SINK_HOLE = registerConfiguredFeature("glowdust_sink_hole", ModFeatures.SINK_HOLE.withConfiguration(new BlockStateFeatureConfig(ModBlocks.GLOWDUST.get().getDefaultState())).withPlacement(Features.Placements.PATCH_PLACEMENT.func_242731_b(40)));
