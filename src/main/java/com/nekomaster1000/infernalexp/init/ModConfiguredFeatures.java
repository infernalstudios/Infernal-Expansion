...
public class ModConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> GLOWSPIKE = registerConfiguredFeature("glowspike", ModFeatures.GLOWSPIKE.withConfiguration(new GlowSpikeFeatureConfig(3, 5, 8, 24, 7, 7, true)).withPlacement(Features.Placements.PATCH_PLACEMENT.func_242731_b(120)));
    public static ConfiguredFeature<?, ?> GLOWSPIKELARGE = registerConfiguredFeature("glowspikelarge", ModFeatures.GLOWSPIKE.withConfiguration(new GlowSpikeFeatureConfig(4, 7, 12, 98, 12, 12, false)).withPlacement(Features.Placements.PATCH_PLACEMENT.func_242731_b(120)));
