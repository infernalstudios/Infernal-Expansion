...
public class ModConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> HANGING_CRIMSON_FUNGUS = registerConfiguredFeature("hanging_crimson_fungus", ModFeatures.HANGING_CRIMSON_FUNGUS.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Features.Placements.PATCH_PLACEMENT.func_242731_b(120)));
