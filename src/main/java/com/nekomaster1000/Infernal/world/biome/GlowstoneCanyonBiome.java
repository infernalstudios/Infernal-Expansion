    ...
    public GlowstoneCanyonBiome() {
        super(new Biome.Builder()
                ...
                .func_235097_a_((new BiomeAmbience.Builder())
                        ...
                        .setMusic(BackgroundMusicTracks.func_232677_a_(SoundEvents.MUSIC_NETHER_BASALT_DELTAS))
                        .build())
                .parent((String)null)
                .func_235098_a_(ImmutableList.of(new Biome.Attributes(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F)))
        );
