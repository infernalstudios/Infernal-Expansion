...
public class ModItems {
    ...
    public static final RegistryObject<ModSpawnEggItem> GLOWSQUITO_SPAWN_EGG = ITEMS.register("glowsquito_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityType.GLOWSQUITO, 0xF0A5A2, 0xA9672B, new Item.Properties().group(InfernalExpansion.TAB)));

    public static final RegistryObject<ModSpawnEggItem> VOLINE_SPAWN_EGG = ITEMS.register("voline_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityType.VOLINE, 0xF0A5A2, 0xA9672B, new Item.Properties().group(InfernalExpansion.TAB)));

    public static final RegistryObject<ModSpawnEggItem> PYRNO_SPAWN_EGG = ITEMS.register("pyrno_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityType.PYRNO, 0xF0A5A2, 0xA9672B, new Item.Properties().group(InfernalExpansion.TAB)));

    public static final RegistryObject<ModSpawnEggItem> WARPBEETLE_SPAWN_EGG = ITEMS.register("warpbeetle_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityType.WARPBEETLE, 0xF0A5A2, 0xA9672B, new Item.Properties().group(InfernalExpansion.TAB)));

    // Block items
    public static final RegistryObject<Item> DIMSTONE_ITEM = ITEMS.register("dimstone",
            () -> new BlockItemBase(ModBlocks.DIMSTONE.get()));

    public static final RegistryObject<Item> DULLSTONE_ITEM = ITEMS.register("dullstone",
            () -> new BlockItemBase(ModBlocks.DULLSTONE.get()));

    public static final RegistryObject<Item> GLOWSTONE_BRICK = ITEMS.register("glowstone_brick",
            () -> new BlockItemBase(ModBlocks.GLOWSTONE_BRICK.get()));

    public static final RegistryObject<Item> DIMSTONE_BRICK = ITEMS.register("dimstone_brick",
            () -> new BlockItemBase(ModBlocks.DIMSTONE_BRICK.get()));

    public static final RegistryObject<Item> DULLSTONE_BRICK = ITEMS.register("dullstone_brick",
            () -> new BlockItemBase(ModBlocks.DULLSTONE_BRICK.get()));

    public static final RegistryObject<Item> GLOWSTONE_SMOOTH = ITEMS.register("glowstone_smooth",
            () -> new BlockItemBase(ModBlocks.GLOWSTONE_SMOOTH.get()));

    public static final RegistryObject<Item> DIMSTONE_SMOOTH = ITEMS.register("dimstone_smooth",
            () -> new BlockItemBase(ModBlocks.DIMSTONE_SMOOTH.get()));

    public static final RegistryObject<Item> DILLSTONE_SMOOTH = ITEMS.register("dullstone_smooth",
            () -> new BlockItemBase(ModBlocks.DULLSTONE_SMOOTH.get()));

    public static final RegistryObject<Item> GLOWSQUITO_GLOWSTONE_BRICK = ITEMS.register("glowsquito_glowstone_brick",
            () -> new BlockItemBase(ModBlocks.GLOWSQUITO_GLOWSTONE_BRICK.get()));

    public static final RegistryObject<Item> CHISELED_GLOWSTONE_BRICK = ITEMS.register("chiseled_glowstone_brick",
            () -> new BlockItemBase(ModBlocks.CHISELED_GLOWSTONE_BRICK.get()));

    public static final RegistryObject<Item> GLOWSQUITO_DIMSTONE_BRICK = ITEMS.register("glowsquito_dimstone_brick",
            () -> new BlockItemBase(ModBlocks.GLOWSQUITO_DIMSTONE_BRICK.get()));

    public static final RegistryObject<Item> CHISELED_DIMSTONE_BRICK = ITEMS.register("chiseled_dimstone_brick",
            () -> new BlockItemBase(ModBlocks.CHISELED_DIMSTONE_BRICK.get()));

    public static final RegistryObject<Item> GLOWSQUITO_DULLSTONE_BRICK = ITEMS.register("glowsquito_dullstone_brick",
            () -> new BlockItemBase(ModBlocks.GLOWSQUITO_DULLSTONE_BRICK.get()));

    public static final RegistryObject<Item> CHISELED_DULLSTONE_BRICK = ITEMS.register("chiseled_dullstone_brick",
            () -> new BlockItemBase(ModBlocks.CHISELED_DULLSTONE_BRICK.get()));

    public static final RegistryObject<Item> GLOWDUST_SAND = ITEMS.register("glowdust_sand",
            () -> new BlockItemBase(ModBlocks.GLOWDUST_SAND.get()));

    public static final RegistryObject<Item> GLOWDUST_SANDSTONE = ITEMS.register("glowdust_sandstone",
            () -> new BlockItemBase(ModBlocks.GLOWDUST_SANDSTONE.get()));

    public static final RegistryObject<Item> CUT_GLOWDUST_SANDSTONE = ITEMS.register("cut_glowdust_sandstone",
            () -> new BlockItemBase(ModBlocks.CUT_GLOWDUST_SANDSTONE.get()));

    public static final RegistryObject<Item> CHISELED_GLOWDUST_SANDSTONE = ITEMS.register("chiseled_glowdust_sandstone",
            () -> new BlockItemBase(ModBlocks.CHISELED_GLOWDUST_SANDSTONE.get()));

    public static final RegistryObject<Item> SMOOTH_GLOWDUST_SANDSTONE = ITEMS.register("smooth_glowdust_sandstone",
            () -> new BlockItemBase(ModBlocks.SMOOTH_GLOWDUST_SANDSTONE.get()));
