...
public class MsMyLanguageProvider extends IELanguageProvider {

    public MsMyLanguageProvider(DataGenerator generator) {
        super(generator, "ms_my");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, "Pengembangan Neraka");
        add(Blocks.GLOWSTONE, "Batu Menyala");
        add(IEBlocks.DIMSTONE.get(), "Batu Malap");
        add(IEBlocks.DULLSTONE.get(), "Batu Pudar");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Batu Menyala Licin");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Batu Malap Licin");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Batu Pudar Licin");
        ...
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "Chiseled Dimstone Brick");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "Chiseled Dullstone Brick");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Papak Batu Menyala Licin");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Tangga Batu Menyala Licin");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Papak Batu Malap Licin");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Tangga Batu Malap Licin");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Papak Batu Pudar Licin");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Tangga Batu Pudar Licin");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Papak Bata Batu Menyala");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Tangga Bata Batu Menyala");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Papak Bata Batu Malap");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Tangga Bata Batu Malap");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Papak Bata Batu Pudar");
        ...
        add(IEBlocks.GLOWDUST.get(), "Serbuk Berkilau");
        add(IEBlocks.GLOWDUST_SAND.get(), "Pasir Serbuk Berkilau");
        add(IEBlocks.GLOWDUST_STONE.get(), "Batu Serbuk Berkilau");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "Batu Hitam Runtuh");
        add(IEBlocks.SILT.get(), "Kelodak Basalt");
        add(IEBlocks.RUBBLE.get(), "Serpihan Batu Hitam");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), "Tanglung Cahaya Berkilau");
        add(IEBlocks.GLOW_TORCH.get(), "Obor Cahaya Berkilau");
        add(IEBlocks.GLOW_CAMPFIRE.get(), "Unggun Api Cahaya Berkilau");
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "Cendawan Bercahaya");
        ...
        add(IEItems.GLOWCOAL.get(), "Arang Batu Berkilau");
        add(IEItems.DULLROCKS.get(), "Batu Kelikir Pudar");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Telur Penjelmaan Voline");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Telur Penjelmaan Shroomloin");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "Telur Penjelmaan Kumbang Gila");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Telur Penjelmaan Menjelma");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Telur Penjelmaan Gergasi Basalt");
        ...
        add(IEEntityTypes.WARPBEETLE.get(), "Kumbang Gila");
        add(IEEntityTypes.EMBODY.get(), "Menjelma");
        add(IEEntityTypes.BASALT_GIANT.get(), "Gergasi Basalt");
