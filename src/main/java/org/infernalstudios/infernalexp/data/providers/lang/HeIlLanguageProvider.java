...
public class HeIlLanguageProvider extends IELanguageProvider {

    public HeIlLanguageProvider(DataGenerator generator) {
        super(generator, "he_il");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, null);
        add(Blocks.GLOWSTONE, "גלוסטון");
        add(IEBlocks.DIMSTONE.get(), "אפלולסטון");
        add(IEBlocks.DULLSTONE.get(), "אטומסטון");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "גלוסטון חלקה");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "אפלולסטון חלקה");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "אטומסטון חלקה");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), "לבני גלוסטון");
        add(IEBlocks.DIMSTONE_BRICKS.get(), "לבני אפלולסטון");
        add(IEBlocks.DULLSTONE_BRICKS.get(), "לבני אטומסטון");
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), "לבני גלוסטון סדוקות");
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), "לבני אפלולסטון סדוקות");
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), "לבני אטומסטון סדוקות");
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), "לבני גלוסטון מפוסלות");
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "לבני אפלולסטון מפוסלות");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "לבני אטומסטון מפוסלות");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "גלוסטון חלקה חצויה");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "מדרגות גלוסטון חלקה");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "אפלולסטון חלקה חצויה");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "מדרגות אפלולסטון חלקה");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "אטומסטון חלקה חצויה");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "מדרגות אטומסטון חלקה");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "לבני גלוסטון חצויות");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "מדרגות לבני גלוסטון");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "לבני אפלולסטון חצויות");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "מדרגות לבני אפלולסטון");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "לבני אטומסטון חצויות");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "מדרגות לבני אטומסטון");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "אבק גלוחול");
        add(IEBlocks.GLOWDUST_SAND.get(), "גלוחול");
        add(IEBlocks.GLOWDUST_STONE.get(), "גלוסטון  מוקשה");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "אבן שחורה מתפוררת");
        add(IEBlocks.SILT.get(), "טין בזלת");
        add(IEBlocks.RUBBLE.get(), "שברי אבן שחורה");
        ...
        add(IEBlocks.CHISELED_SOUL_SLATE_BRICKS.get(), "Chiseled Soul Slate Brick");
        add(IEBlocks.CHARGED_CHISELED_SOUL_SLATE_BRICKS.get(), "Charged Chiseled Soul Slate Brick");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), "עששית גלואור");
        add(IEBlocks.GLOW_TORCH.get(), "לפיד גלואור");
        add(IEBlocks.GLOW_CAMPFIRE.get(), "מדורת גלואור");
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "פטריית זוהר");
        add(IEBlocks.DULLTHORNS.get(), "אטוםת'ורן");
        ...
        add(IEItems.GLOWCOAL.get(), "פחם גלוסטון");
        add(IEItems.DULLROCKS.get(), "סלעים אטומים");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "ביצת זימון געשין");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "ביצת זימון פטרילוין");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "ביצת זימון חיפושעוות");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "ביצת זימון גילום");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "בימת זימון ענק בזלת");
        ...
        add(IEEntityTypes.VOLINE.get(), "געשין");
        add(IEEntityTypes.SHROOMLOIN.get(), "פטרילוין");
        add(IEEntityTypes.WARPBEETLE.get(), "חיפושעוות");
        add(IEEntityTypes.EMBODY.get(), "גילום");
        add(IEEntityTypes.BASALT_GIANT.get(), "ענק בזלת");
