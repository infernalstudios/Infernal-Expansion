...
public class ZhTwLanguageProvider extends IELanguageProvider {

    public ZhTwLanguageProvider(DataGenerator generator) {
        super(generator, "zh_tw");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, null);
        add(Blocks.GLOWSTONE, "螢光石");
        add(IEBlocks.DIMSTONE.get(), "黯螢石");
        add(IEBlocks.DULLSTONE.get(), "黯淡石");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "平滑螢光石");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "平滑黯螢石");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "平滑黯淡石");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), "螢光石磚");
        add(IEBlocks.DIMSTONE_BRICKS.get(), "黯螢石磚");
        add(IEBlocks.DULLSTONE_BRICKS.get(), "黯淡石磚");
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), "裂紋螢光石磚");
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), "裂紋黯螢石磚");
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), "裂紋黯淡石磚");
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), "鏨制螢光石磚");
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "鏨制黯螢石磚");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "鏨制黯淡石磚");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "平滑螢光石半磚");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "平滑螢光石階梯");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "平滑黯螢石半磚");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "平滑黯螢石階梯");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "平滑黯淡石半磚");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "平滑黯淡石階梯");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "螢光石磚半磚");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "螢光石磚階梯");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "黯螢石磚半磚");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "黯螢石磚階梯");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "黯淡石磚半磚");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "黯淡石磚階梯");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "螢光土");
        add(IEBlocks.GLOWDUST_SAND.get(), "螢光沙");
        add(IEBlocks.GLOWDUST_STONE.get(), "螢光岩");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "破碎黑石");
        add(IEBlocks.SILT.get(), "玄武岩粉砂");
        add(IEBlocks.RUBBLE.get(), "黑石粉砂");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), "螢光燈籠");
        add(IEBlocks.GLOW_TORCH.get(), "螢光火把");
        add(IEBlocks.GLOW_CAMPFIRE.get(), "螢光篝火");
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "閃爍蕈菇");
        add(IEBlocks.DULLTHORNS.get(), "黯淡灌木");
        ...
        add(IEItems.GLOWCOAL.get(), "螢光焦炭");
        add(IEItems.DULLROCKS.get(), "黯淡岩粒");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "荒原嗜怪生怪蛋");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "緋紅靈蕈生怪蛋");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "扭曲甲蟲生怪蛋");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "靈魂沙鬼生怪蛋");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "玄武岩像生怪蛋");
        ...
        add(IEEntityTypes.VOLINE.get(), "荒原嗜怪");
        add(IEEntityTypes.SHROOMLOIN.get(), "緋紅靈蕈");
        add(IEEntityTypes.WARPBEETLE.get(), "扭曲甲蟲");
        add(IEEntityTypes.EMBODY.get(), "靈魂沙鬼");
        add(IEEntityTypes.BASALT_GIANT.get(), "玄武岩像");
