...
public class PtBrLanguageProvider extends IELanguageProvider {

    public PtBrLanguageProvider(DataGenerator generator) {
        super(generator, "pt_br");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, "Expansão Infernal");
        add(Blocks.GLOWSTONE, "Pedra Luminosa");
        add(IEBlocks.DIMSTONE.get(), "Pedra Obscura");
        add(IEBlocks.DULLSTONE.get(), "Pedra Opaca");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Pedra Luminosa Suave");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Pedra Obscura Suave");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Pedra Opaca Suave");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), null);
        add(IEBlocks.DIMSTONE_BRICKS.get(), null);
        add(IEBlocks.DULLSTONE_BRICKS.get(), null);
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), null);
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), null);
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), null);
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), null);
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), null);
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Laje de Pedra Luminosa Suave");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Escadas de Pedra Luminosa Suave");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Laje de Pedra Obscura Suave");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Escadas de Pedra Obscura Suave");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Laje de Pedra Opaca Suave");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Escadas de Pedra Opaca Suave");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Laje de Tijolos de Pedra Luminosa");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Escadas de Tijolos de Pedra Luminosa");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Laje de Tijolos de Pedra Obscurab");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Escadas de Tijolos de Pedra Obscura");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Laje de Tijolos de Pedra Opaca");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "Escadas de Tijolos de Pedra Opaca");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "Pó Luminoso");
        add(IEBlocks.GLOWDUST_SAND.get(), "Areia de Pó Luminoso");
        add(IEBlocks.GLOWDUST_STONE.get(), "Pedra de Pó Luminoso");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "Pedra Negra Desintegrada");
        add(IEBlocks.SILT.get(), "Lodo de Basalto");
        add(IEBlocks.RUBBLE.get(), "Escombros de Pedra Negra ");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), null);
        add(IEBlocks.GLOW_TORCH.get(), null);
        add(IEBlocks.GLOW_CAMPFIRE.get(), null);
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "Fungo Luminoso");
        add(IEBlocks.DULLTHORNS.get(), "Espinhos Opacos");
        ...
        add(IEItems.GLOWCOAL.get(), "Carvão Luminoso");
        add(IEItems.DULLROCKS.get(), "Pepita Luminosa");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Ovo Gerador de Vulino");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Ovo Gerador de Coguloin");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "Ovo Gerador de Besouro Distorcido");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Ovo Gerador de Incorporado");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Ovo Gerador de Gigante de Basalto");
        ...
        add(IEEntityTypes.VOLINE.get(), "Vulino");
        add(IEEntityTypes.SHROOMLOIN.get(), "Coguloin");
        add(IEEntityTypes.WARPBEETLE.get(), "Besouro Distorcido");
        add(IEEntityTypes.EMBODY.get(), "Incorporado");
