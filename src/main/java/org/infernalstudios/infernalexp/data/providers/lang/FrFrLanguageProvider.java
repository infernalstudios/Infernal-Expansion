...
public class FrFrLanguageProvider extends IELanguageProvider {

    public FrFrLanguageProvider(DataGenerator generator) {
        super(generator, "fr_fr");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, "Expansion infernale");
        add(Blocks.GLOWSTONE, "Pierre lumineuse");
        add(IEBlocks.DIMSTONE.get(), "Pierre pénombrale");
        add(IEBlocks.DULLSTONE.get(), "Pierre terne");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Pierre lumineuse lisse");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Pierre pénombrale lisse");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Pierre terne lisse");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), "Briques de pierre lumineuse");
        add(IEBlocks.DIMSTONE_BRICKS.get(), "Briques de pierre pénombrale");
        add(IEBlocks.DULLSTONE_BRICKS.get(), "Briques de pierre terne");
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), "Briques de pierre lumineuse craquelée");
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), "Briques de pierre pénombrale craquelée");
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), "Biques de pierre terne craquelée");
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), "Briques de pierre lumineuse sculptée");
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "Briques de pierre pénombrale sculptée");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "Briques de pierre terne sculptée");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Dalle en pierre lumineuse lisse");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Escalier en pierre lumineuse lisse");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Dalle en pierre pénombrale lisse");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Escalier en pierre pénombrale lisse");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Dalle en pierre terne lisse");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Escalier en pierre terne lisse");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Dalle en briques de pierre lumineuse");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Escalier en briques de pierre lumineuse");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Dalle en briques de pierre pénombrale");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Escalier en briques de pierre pénombrale");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Dalle en briques de pierre terne");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "Escalier en briques de pierre terne");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "Poudre lumineuse");
        add(IEBlocks.GLOWDUST_SAND.get(), "Sable lumineux");
        add(IEBlocks.GLOWDUST_STONE.get(), "Pierre de sable lumineux");
        add(IEBlocks.GLOWDUST_STONE_SLAB.get(), "Glowdust Stone Slab");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "Roche noire effritée");
        add(IEBlocks.SILT.get(), "Limon de basalte");
        add(IEBlocks.RUBBLE.get(), "Décombres de roche noire");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), "Lanterne brillante");
        add(IEBlocks.GLOW_TORCH.get(), "Torche brillante");
        add(IEBlocks.GLOW_CAMPFIRE.get(), "Feu de camp brillant");
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "Champignion lumineux");
        add(IEBlocks.DULLTHORNS.get(), "Épines ternes");
        ...
        add(IEItems.GLOWCOAL.get(), "Charbon brillant");
        add(IEItems.DULLROCKS.get(), "Roches ternes");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Oeuf d'apparition de Voline");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Oeuf d'apparition de Champiboom");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "Oeuf d'apparition de scarabée biscornu");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Oeuf d'apparition d'Incarné");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Oeuf d'apparition de géant de basalte");
        ...
        add(IEEntityTypes.SHROOMLOIN.get(), "Champiboom");
        add(IEEntityTypes.WARPBEETLE.get(), "Scarabée biscornu");
        add(IEEntityTypes.EMBODY.get(), "Incarné");
        add(IEEntityTypes.BASALT_GIANT.get(), "Géant de basalte");
