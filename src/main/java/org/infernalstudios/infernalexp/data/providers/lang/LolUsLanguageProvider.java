...
public class LolUsLanguageProvider extends IELanguageProvider {

    public LolUsLanguageProvider(DataGenerator generator) {
        super(generator, "lol_us");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, "Infurnal Expanshun lol");
        add(Blocks.GLOWSTONE, null);
        add(IEBlocks.DIMSTONE.get(), "less-glowy stone");
        add(IEBlocks.DULLSTONE.get(), "Not-glowy stone");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Smooooth glowstone");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Smooooth less-glowy stone");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Smooooth not-glowy stone");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), "Glowstone brickz");
        add(IEBlocks.DIMSTONE_BRICKS.get(), "less-glowy brickz");
        add(IEBlocks.DULLSTONE_BRICKS.get(), "Not-glowy brickz");
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), "My <3 is shattered");
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), "Broken less-glowy brickz");
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), "Broken not-glowy brickz");
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), "Carved glowstone brickz");
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "Carved less-glowy brickz");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "Carved not-glowy brickz");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Smooooth glowstone slab");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Smooooth glowstone stairz");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Smooooth less-glowy stone slab");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Smooooth less-glowy stone stairz");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Smooooth not-glowy slab");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Smooooth not-glowy stairz");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Glowstone brik slab");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Glowstone brik stairz");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Less-glowy brik slab");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Less-glowy brik stairz");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Not-glowy brik slab");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "Not-glowy brik stairz");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "Shiney dust");
        add(IEBlocks.GLOWDUST_SAND.get(), "shiney beach dust");
        add(IEBlocks.GLOWDUST_STONE.get(), "Shiney dust rock");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "bleck rock in poor conditoinsn");
        add(IEBlocks.SILT.get(), "Blec sand");
        add(IEBlocks.RUBBLE.get(), "Blecston peaces");
        ...
        add(IEBlocks.GLOW_LANTERN.get(), "Lanternier lantern");
        add(IEBlocks.GLOW_TORCH.get(), "Torchier torch");
        add(IEBlocks.GLOW_CAMPFIRE.get(), "Campfireier campfire");
        add(IEBlocks.GLOW_GLASS.get(), null);
        add(IEBlocks.GLOW_GLASS_PANE.get(), null);
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "bright plant thing");
        add(IEBlocks.DULLTHORNS.get(), "unwatered plant r.i.p.");
        ...
        add(IEItems.GLOWCOAL.get(), "shiny coallll");
        add(IEItems.DULLROCKS.get(), "sad rockz :(");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Chomp chomp chomp CHOMP spon ec");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Fun guy spon ec");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "EW ITS SO GROSS where did it go spon ec");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Some ghost guy idk >:( spon ec");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Big bawzult boy spon ec");
        ...
        add(IEEntityTypes.VOLINE.get(), "Chomp chomp chomp CHOMP");
        add(IEEntityTypes.SHROOMLOIN.get(), "Fun guy");
        add(IEEntityTypes.WARPBEETLE.get(), "EW ITS SO GROSS where did it go");
        add(IEEntityTypes.EMBODY.get(), "Some ghost guy idk >:(");
        add(IEEntityTypes.BASALT_GIANT.get(), "Big bawzult boy");
        ...
        add(InfernalExpansion.MOD_ID + ".commands.setdimensionspawn.success.multiple", null);add(IEBlocks.LUMINOUS_STEM.get(), null);
        ...
        addEntitySubtitles(IEEntityTypes.BLINDSIGHT.get(), null, "Blindsight shrieks", null);
