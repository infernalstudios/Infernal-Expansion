...
public class RoRoLanguageProvider extends IELanguageProvider {

    public RoRoLanguageProvider(DataGenerator generator) {
        super(generator, "ro_ro");
    }

    @Override
    protected void addTranslations() {
        add(InfernalExpansion.TAB, "Expansiune Infernala");
        add(Blocks.GLOWSTONE, "Piatra Luminoasa");
        add(IEBlocks.DIMSTONE.get(), "Piatra Slaba");
        add(IEBlocks.DULLSTONE.get(), "Piatra Stinsa");
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Piatra Luminoasa Neteda");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Piatra Slaba Neteda");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Piatra Stinsa Neteda");
        ...
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Placa de Piatra Luminoasa Neteda");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Scari de Piatra Luminoasa Netede");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Placa de Piatra Slaba Neteda");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Scari de Piatra Slaba Netede");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Placa de Piatra Stinsa Neteda");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Scari de Piatra Stinsa Netede");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Placa de Caramizi de Piatra Luminoasa");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Scari de Caramizi de Piatra Luminoasa");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Placa de Caramizi de Piatra Slaba");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Scari de Caramizi de Piatra Slaba");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Placa de Caramizi de Piatra Stinsa");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "Scari de Caramizi de Piatra Stinsa");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), "Praf Luminos");
        add(IEBlocks.GLOWDUST_SAND.get(), "Nisip Luminos");
        add(IEBlocks.GLOWDUST_STONE.get(), "Piatra de Praf Luminos");
        ...
        add(IEBlocks.CRUMBLING_BLACKSTONE.get(), "Piatra Neagra Sfarmata");
        add(IEBlocks.SILT.get(), "Nisip Basaltic");
        add(IEBlocks.RUBBLE.get(), "Moloz de Piatra Neagra");
        ...
        add(IEBlocks.LUMINOUS_FUNGUS.get(), "Fungus Luminos");
        add(IEBlocks.DULLTHORNS.get(), "Ghimpe Stinse");
        ...
        add(IEItems.DULLROCKS.get(), "Pepita Luminoasa");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Ou de Creare Volcanit");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Ou de Creare Ciuperloin");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "Ou de Creare Carabus Strain");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Ou de Creare Intruchipare");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Ou de Creare Gigant Basaltic");
        ...
        add(IEEntityTypes.VOLINE.get(), "Volcanit");
        add(IEEntityTypes.SHROOMLOIN.get(), "Ciuperloin");
        add(IEEntityTypes.WARPBEETLE.get(), "Carabus Strain");
        add(IEEntityTypes.EMBODY.get(), "Intruchipare");
        add(IEEntityTypes.BASALT_GIANT.get(), "Gigant Basaltic");
