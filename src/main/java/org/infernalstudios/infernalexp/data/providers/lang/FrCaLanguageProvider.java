...
public class FrCaLanguageProvider extends IELanguageProvider {

    public FrCaLanguageProvider(DataGenerator generator) {
        super(generator, "fr_ca");
    }
    ...
    protected void addTranslations() {
        ...
        add(IEBlocks.DIMSTONE.get(), null);
        add(IEBlocks.DULLSTONE.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE.get(), "Glowstone lisse");
        add(IEBlocks.SMOOTH_DIMSTONE.get(), "Dimstone lisse");
        add(IEBlocks.SMOOTH_DULLSTONE.get(), "Dullstone lisse");
        add(IEBlocks.GLOWSTONE_BRICKS.get(), "Briques de glowstone");
        add(IEBlocks.DIMSTONE_BRICKS.get(), "Briques de dimstone");
        add(IEBlocks.DULLSTONE_BRICKS.get(), "Briques de dullstone");
        add(IEBlocks.CRACKED_GLOWSTONE_BRICKS.get(), "Briques de glowstone craquelées");
        add(IEBlocks.CRACKED_DIMSTONE_BRICKS.get(), "Briques de dimstone craquelées");
        add(IEBlocks.CRACKED_DULLSTONE_BRICKS.get(), "Biques de dullstone craquelées");
        add(IEBlocks.CHISELED_GLOWSTONE_BRICKS.get(), "Briques de glowstone ciselées");
        add(IEBlocks.CHISELED_DIMSTONE_BRICKS.get(), "Briques de dimstone ciselées");
        add(IEBlocks.CHISELED_DULLSTONE_BRICKS.get(), "Briques de dullstone ciselées");
        add(IEBlocks.SMOOTH_GLOWSTONE_SLAB.get(), "Dalle de glowstone lisse");
        add(IEBlocks.SMOOTH_GLOWSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_STAIRS.get(), "Escaliers de glowstone lisse");
        add(IEBlocks.SMOOTH_GLOWSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_GLOWSTONE_PRESSURE_PLATE.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_SLAB.get(), "Dalle de dimstone lisse");
        add(IEBlocks.SMOOTH_DIMSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DIMSTONE_STAIRS.get(), "Escaliers de dimstone lisse");
        add(IEBlocks.SMOOTH_DIMSTONE_BUTTON.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_SLAB.get(), "Dalle de dullstone lisse");
        add(IEBlocks.SMOOTH_DULLSTONE_VERTICAL_SLAB.get(), null);
        add(IEBlocks.SMOOTH_DULLSTONE_STAIRS.get(), "Escaliers de dullstone lisse");
        add(IEBlocks.SMOOTH_DULLSTONE_BUTTON.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_SLAB.get(), "Dalle de briques de glowstone");
        add(IEBlocks.GLOWSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.GLOWSTONE_BRICK_STAIRS.get(), "Escaliers de briques de glowstone");
        add(IEBlocks.GLOWSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_SLAB.get(), "Dalle de briques de dimstone");
        add(IEBlocks.DIMSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DIMSTONE_BRICK_STAIRS.get(), "Escaliers de briques de dimstone");
        add(IEBlocks.DIMSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_SLAB.get(), "Dalle de briques de dullstone");
        add(IEBlocks.DULLSTONE_BRICK_VERTICAL_SLAB.get(), null);
        add(IEBlocks.DULLSTONE_BRICK_STAIRS.get(), "Escaliers de briques de dullstone");
        add(IEBlocks.DULLSTONE_BRICK_WALL.get(), null);
        add(IEBlocks.LUMINOUS_WART_BLOCK.get(), null);
        add(IEBlocks.GLOWDUST.get(), null);
        add(IEBlocks.GLOWDUST_SAND.get(), "Sable de glowdust");
        add(IEBlocks.GLOWDUST_STONE.get(), "Pierre de glowdust");
        ...
        add(IEItems.VOLINE_SPAWN_EGG.get(), "Oeuf spawner de Voline");
        add(IEItems.SHROOMLOIN_SPAWN_EGG.get(), "Oeuf spawner de Champiboom");
        add(IEItems.WARPBEETLE_SPAWN_EGG.get(), "Oeuf spawner de scarabée tordu");
        add(IEItems.EMBODY_SPAWN_EGG.get(), "Oeuf spawner d'Incarné");
        add(IEItems.BASALT_GIANT_SPAWN_EGG.get(), "Oeuf spawner de géant de basalte");
        ...
        add(IEEntityTypes.WARPBEETLE.get(), "Scarabée tordu");
