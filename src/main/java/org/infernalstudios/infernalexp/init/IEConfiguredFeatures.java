...
public class IEConfiguredFeatures {
    ...
    public static Holder<ConfiguredFeature<?, ?>> LUMINOUS_FUNGUS = registerConfiguredFeature("luminous_fungus", IEFeatures.LUMINOUS_FUNGUS);
    public static Holder<ConfiguredFeature<?, ?>> DULLTHORNS = registerConfiguredFeature("dullthorns", IEFeatures.DULLTHORNS);
    public static Holder<ConfiguredFeature<?, ?>> GSC_SPRING_OPEN = registerConfiguredFeature("gsc_spring_open", Feature.SPRING, new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, Blocks.NETHERRACK, IEBlocks.DULLSTONE.get(), IEBlocks.DIMSTONE.get())));
    public static Holder<ConfiguredFeature<?, ?>> GSC_SPRING_CLOSED = registerConfiguredFeature("gsc_spring_closed", Feature.SPRING, new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 5, 0, HolderSet.direct(Block::builtInRegistryHolder, Blocks.NETHERRACK, IEBlocks.DULLSTONE.get(), IEBlocks.DIMSTONE.get())));
    public static Holder<ConfiguredFeature<?, ?>> BLACKSTONE_BOULDER = registerConfiguredFeature("blackstone_boulder", IEFeatures.BOULDER, new BlockStateConfiguration(Blocks.BLACKSTONE.defaultBlockState()));
    public static Holder<ConfiguredFeature<?, ?>> GSC_BLACKSTONE_BLOBS = registerConfiguredFeature("gsc_blackstone_blob", Feature.REPLACE_BLOBS, new ReplaceSphereConfiguration(IEBlocks.DULLSTONE.get().defaultBlockState(), Blocks.BLACKSTONE.defaultBlockState(), UniformInt.of(2, 3)));
    public static Holder<ConfiguredFeature<?, ?>> ORE_GLOWSILK_COCOON = registerConfiguredFeature("ore_glowsilk_cocoon", Feature.SCATTERED_ORE, new OreConfiguration(OreFeatures.NETHER_ORE_REPLACEABLES, IEBlocks.GLOWSILK_COCOON.get().defaultBlockState(), 2));
    public static Holder<ConfiguredFeature<?, ?>> ORE_BASALT_IRON = registerConfiguredFeature("ore_basalt_iron", Feature.ORE, new OreConfiguration(BASALT, IEBlocks.BASALT_IRON_ORE.get().defaultBlockState(), 8));
