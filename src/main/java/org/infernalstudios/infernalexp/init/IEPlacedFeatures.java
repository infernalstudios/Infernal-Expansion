...
public class IEPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> PATCH_WARPED_CAP = registerPlacedFeature("patch_warped_cap", IEConfiguredFeatures.PATCH_WARPED_CAP, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
    public static final Holder<PlacedFeature> PATCH_CRIMSON_CAP = registerPlacedFeature("patch_crimson_cap", IEConfiguredFeatures.PATCH_CRIMSON_CAP, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
