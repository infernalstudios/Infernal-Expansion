...
public class IEPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> DULLSTONE_DEATH_PIT = registerPlacedFeature("dullstone_death_pit", IEConfiguredFeatures.DULLSTONE_DEATH_PIT, CountPlacement.of(90), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
    ...
    public static final Holder<PlacedFeature> PATCH_WARPED_CAP = registerPlacedFeature("patch_warped_cap", IEConfiguredFeatures.PATCH_WARPED_CAP, CountOnEveryLayerPlacement.of(6), BiomeFilter.biome());
    public static final Holder<PlacedFeature> PATCH_CRIMSON_CAP = registerPlacedFeature("patch_crimson_cap", IEConfiguredFeatures.PATCH_CRIMSON_CAP, CountOnEveryLayerPlacement.of(6), BiomeFilter.biome());
    public static final Holder<PlacedFeature> SHROOMLIGHT_TEAR = registerPlacedFeature("shroomlight_tear", IEConfiguredFeatures.SHROOMLIGHT_TEAR, CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
    public static final Holder<PlacedFeature> PATCH_BURIED_BONE = registerPlacedFeature("patch_buried_bone", IEConfiguredFeatures.PATCH_BURIED_BONE, CountOnEveryLayerPlacement.of(10), BiomeFilter.biome());
    ...
    public static final Holder<PlacedFeature> PATCH_PLANTED_QUARTZ = registerPlacedFeature("planted_quartz_patch", IEConfiguredFeatures.PATCH_PLANTED_QUARTZ, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
