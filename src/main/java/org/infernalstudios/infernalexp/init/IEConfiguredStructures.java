...
public class IEConfiguredStructures {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> BASALT_GIANT_MOAI = registerConfiguredStructure("basalt_giant_moai", IEStructures.SIMPLE_NETHER_STRUCTURE.configured(new SizeCheckingConfiguration(IEStructurePools.BASALT_GIANT_MOAI, 1, 4), IETags.Biomes.HAS_BASALT_GIANT_MOAI, true));
